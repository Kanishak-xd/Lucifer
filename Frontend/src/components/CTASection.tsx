  ...
  return (
    <section className="py-6 bg-black dark:bg-red-950">
        <div className="container mx-auto flex flex-col items-center justify-center p-4 space-y-11 md:p-10 px-10 sm:px-16 md:px-24 xl:px-48">
            ...
            <button className="px-8 py-3 text-lg font-bold rounded-xl bg-white text-black dark:bg-black dark:text-white hover:cursor-pointer dark:hover:bg-neutral-900 hover:bg-neutral-200">Add to Server</button>
        </div>
    </section>
  )
}
